 ...
 */
public class GetUserPosition extends HttpServlet {
    ...
    String authenticationKey, appVer, osID, deviceId, deviceName, osVer, userId, x, y;
    double userX, userY;
    SubRoad subRoad;
    Road road;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (request.getParameter("jsonFile") != null) {
                ...
                if (message.isEmpty()) {
//                    userX = Double.parseDouble(x);
//                    userY = Double.parseDouble(y);
//                    subRoad = new PossitionHandler().getSubRoadOfCertainPosissition(userX, userY);
//                    JsonObject success = new JsonObject();
//                    success.addProperty("message", subRoad.toString());
...
//                    out.println(jsonString);
                    ...
                    // serviceLayer URL
                    URL url = new URL(ErrorCodesConstants.serviceLayerURLOnITIServer + "/GetRoadByPosition");
...
//                    connection.setRequestProperty("Content-type", "application/x-www-form-urlencoded;charset=" + charset);
                    ...
                    JObject.addProperty("x", x);
                    JObject.addProperty("y", y);
